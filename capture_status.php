...
<title>Legion Servers Military RP</title>
...
<body>
<center><strong><h1 style="color:white;">Capture Status</h1></strong></center>
...
$sql = 'select * from captured_regions_data';
...
while ($row = mysqli_fetch_array($query))
{
	echo ' <tr>
	<td>' .$row['region'].'</td>
    <td>' .$row['holding_team'].'</td>
    <td>' .$row['capturing_team'].'</td>
    <td>' .$row['capture_start'].'</td>
	<td>' .$row['capture_fail_time'].'</td>
	</tr>';
}
